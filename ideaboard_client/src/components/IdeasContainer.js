...
class IdeasContainer extends Component {
  ...
  componentDidMount() {
    axios.get('https://localhost:3001/api/v1/ideas.json')
    .then(response => {
  ...
  addNewIdea = () => {
    axios.post('https://localhost:3001/api/v1/ideas', {idea: {title: '', body: ''}})
    .then(response => {
  ...
  deleteIdea = (id) => {
    axios.delete(`https://localhost:3001/api/v1/ideas/${id}`)
    .then(response => {
